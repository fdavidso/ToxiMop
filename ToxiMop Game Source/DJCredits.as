package  
{
	 ...
	 */
	public class DJCredits extends Sprite 
	{
		...
		[Embed(source = "../Assets/Art/credits.png")] private var CreditsScreenImage:Class;
		private var creditsScreen_:Bitmap = new Bitmap;
		...
		{	
			...
			this.removeChild( creditsScreen_ );
		...
		{
			creditsScreen_ = new CreditsScreenImage();
			this.addChild( creditsScreen_ );
			creditsScreen_.width *= SCALING_FACTOR;
			creditsScreen_.height *= SCALING_FACTOR;
