function [dx_dt]= v1_odes_setup_PP1_TATproduction_export(t,x)
...
%
% Usage:
% [t, x] = ode45(@v1_odes_setup_PP1_TATproduction_export,[time interval],[initial conditions],[]);
% [t, x] = ode45(@v1_odes_setup_PP1_TATproduction_export,[0,1200],[0,0],[]);

% Written by Craig Johnston, 24th June 2013
